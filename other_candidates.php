...
if(isset($_POST['other_candidates']))
{
	...
	if(!empty($cr_name) && !empty($cr_pname) && !empty($cr_address) && !empty($cr_country) && !empty($cr_government_id) && !empty($cr_aadhar_number) &&  !empty($cr_mobile) && !empty($cr_email) && !empty($cr_alterno) && !empty($cr_joinas) && !empty($cr_clgcom) && ($cr_mobile_1==10) && ($cr_alterno_1==10) && !empty($cr_cname) && !empty($cr_c_code) && !empty($cr_c_fee) && !empty($cr_o_fee) && !empty($cr_r_fee) && !empty($cr_cr_name) && !empty($cr_joining_date))
	{
		
		$cr_sql = "insert into admission(cr_name,cr_pname,cr_address,cr_country,cr_government_id,cr_aadhar_number,cr_mobile,cr_email,cr_alterno,cr_joinas,cr_clgcom,cr_cname,cr_c_code,cr_c_fee,cr_o_fee,cr_r_fee,cr_cr_name,cr_joining_date,is_indian) VALUES('$cr_name','$cr_pname','$cr_address','$cr_country','$cr_government_id','$cr_aadhar_number','$cr_mobile','$cr_email','$cr_joinas','$cr_clgcom','$cr_alterno','$cr_cname','$cr_c_code','$cr_c_fee','$cr_o_fee','$cr_r_fee','$cr_cr_name','$cr_joining_date','$is_indian')";
		$cr_result = mysqli_query($con,$cr_sql);
		if($cr_result)
		{
			
			$subject = 'Other Country Candidates - New Admission';
			$message = "<strong>Candidates Details</strong> <br> 
						Name : $cr_name <br>
						Parents Name : $cr_pname <br>
						Address : $cr_address <br> 
						Country : $cr_country <br> 
						Government Id : $cr_government_id <br> 	
						ID Number : $cr_aadhar_number <br> 
						Email : $cr_email <br> 
						Mobile : $cr_mobile <br> 
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8 shadow-lg p-3 mb-5">
				<center><h3>ADMISSION FORM (OTHER COUNTRY CANDIDATES)</h3>
				...
				<div class="enq_form">
					<form action="other_candidates.php" id="carrer_form" method="post" enctype="multipart/form-data">
							<div class="field">	
							<div class="field_2">
							...
							<div class="field_2">
							<input name="cr_country" <?php if(isset($class4)){ echo $class4;}?> id="cr_country" type="text" placeholder="* Country">
							</div>
							<div class="field_2">
							<select id="cr_government_id" <?php if(isset($class5)){ echo $class10;}?> name="cr_government_id">
							<option value="">* Government Id Proof</option>
							<option value="Fresher">Driving Licence</option>
							...
							<div class="field_2">
							<input name="cr_aadhar_number" <?php if(isset($class19)){ echo $class19;}?> id="cr_aadhar_number" type="text" placeholder="* ID Number">
							</div>	
							<div class="field_2">
							...
							<div class="field_2">
							<input name="cr_joining_date" <?php if(isset($class18)){ echo $class18;}?> id="cr_joining_date" type="text" placeholder="* Course Joinging Date">
							</div>
							<input name="other_candidates" type="hidden">
							<center>
