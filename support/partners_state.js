...
{
   if($val=='SELECT STATE') {
    var options = '<select class="form-control" id="p_district_1" name="p_district_1" required>';
  $('#district_list').html(options);
  }
...
function select_district_1($val)
{
   if($val=='SELECT STATE') {
    var options = '<select class="form-control" id="p_center_district_1" name="p_center_district_1" required>';
  $('#district_list_1').html(options);
  }
 if($val=='Andhra Pradesh') {
   var andhra = ["Anantapur","Chittoor","East Godavari","Guntur","Krishna","Kurnool","Prakasam","Srikakulam","SriPotti Sri Ramulu Nellore",
                                    "Vishakhapatnam","Vizianagaram","West Godavari","Cudappah"];
