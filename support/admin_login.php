...
<?php include('admin_signin_head.php');
...
if(isset($_POST['admin_signin']))
{
	...
	$studentsql = "select a_id,admin_name from admin_login where admin_email='$student_email' and admin_password='$student_password'";
	...
	else if($presult_1>0)
	{
		...
		$st_name = $presult_2['admin_name'];
		$st_id = $presult_2['a_id'];
		session_start();
		$_SESSION["a_id"] = $st_id;
		$_SESSION["a_name"] = $st_name;
		$_SESSION["a_email"] = $student_email;
		header('Location: partners_admin_dashboard');
	}
	else
	{
							...
							<div class="card">
								...
								<div class="body">
									<div class="row">
										...
										<div class="col-md-7">
													<form id="sign_in" method="POST" action="admin_login">
														<div class="msg" align="center"><?=isset($p_output)? '<span class="text-danger font-weight-bold">'.$p_output.'</span>' : 'Welcome to Innovaskill Admin Login'?></div>
														...
														<div class="input-group">
															...
															<div class="form-line">
																...
																<input type="hidden" name="admin_signin">
